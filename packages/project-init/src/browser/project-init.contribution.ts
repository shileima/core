...
import { ProjectInitServicesView } from './project-init.view';


const COMPONENTS_VIEW_COMMAND = {
  id: 'opensumi-project-init-sample',
};

const COMPONENTS_ID = 'opensumi-samples:services';
export const COMPONENTS_SCHEME_ID = 'project-init';

@Domain(BrowserEditorContribution, ClientAppContribution, CommandContribution, MenuContribution)
export class BuiltinServicesContribution
  implements ClientAppContribution, BrowserEditorContribution, CommandContribution, MenuContribution
{
  ...
  registerEditorComponent(registry: EditorComponentRegistry) {
    registry.registerEditorComponent({
      ...
      component: ProjectInitServicesView,
